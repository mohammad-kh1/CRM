<x-app title="Create Project">
    <div class="p-4 sm:ml-64">
        ...
        <div class="border-2 border-gray-200 dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            @endif
            <form class="mx-auto p-2" method="POST" action="{{ route('projects.update',$project->id) }}">
                @csrf
                @method("PATCH")
                {{-- START TITLE --}}
                <div class="mb-5 p-2">
                ...
                <div class="mb-5 p-2">
                    <div class="mb-5 p-2">
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input datepicker datepicker-orientation="bottom right" datepicker-format="yyyy-mm-dd"  type="text" id="datepick" value="{{ $project->deadline }}" name="deadline"
                ...
                <div class="mb-5 p-2">
                    <div class="mb-5 p-2">
                        ...
                        <select id="countries" name="user_id"
                            ...
                            <option selected value="{{ $project->user->id }}">{{ $project->user->fullName }}</option>
                ...
                <div class="mb-5 p-2">
                    <div class="mb-5 p-2">
                        ...
                        <select id="countries" name="client_id"
                            ...
                            @foreach($project->allClients() as $client)
                ...
                <div class="mb-5 p-2">
                    <div class="mb-5 p-2">
                        ...
                        <select id="countries" name="status"
                            ...
                            @foreach($project::STATUS_LIST as $status)
