            ...
            <a href="{{ route('users.create') }}">
                ...
                <form class="max-w-lg  mb-40" method="GET" action="{{ route('users.filter') }}">
                    <div class="flex">
                        ...
                        <select id="search-dropdown" name="filter" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600">
                            <option value="first_name" {{ \Illuminate\Support\Facades\Request::get("filter") == "first_name" ? "selected" : ""  }}>Firstname</option>
                            <option value="last_name" {{ \Illuminate\Support\Facades\Request::get("filter") == "last_name" ? "selected" : ""  }}>Lastname</option>
                            <option value="email" {{ \Illuminate\Support\Facades\Request::get("filter") == "email" ? "selected" : ""  }}>email</option>
                        </select>
